...
class Conversation:
    ...
    # Default values
    conversation_id: str = None  # Tricky one... Is set first when we've pushed to firestore so it has to be None at initialisation
...
@dataclass
class FirestoreMessage(UserMessage):
