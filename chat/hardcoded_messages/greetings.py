...
interview_no_small_talk = [
    ...
    "Hej och välkommen! Vi börjar direkt med din intervju",
]

first_transition = [
    "Så, nu tänkte jag att vi börjar intervjun. ",
    "Nu kommer jag att börja ställa intervjufrågor. ",
    "Jag kommer att börja intervjun nu. ",
]
